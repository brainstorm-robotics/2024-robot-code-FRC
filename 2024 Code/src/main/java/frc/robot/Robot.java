...
public class Robot extends TimedRobot {
   ...
   */
  private final String FRC7509_2024_Code_Version = "Version 0.1b - February 19, 2023";
  ...
  public void robotInit() {
    ...
    SmartDashboard.putString("Version", FRC7509_2024_Code_Version);

    // assume red alliance unless changed in SmartDashboard
    //
    // IMPORTANT: this toggle must be consistent with robot
    // bumpers otherwise planned paths may not be reversed
    // when required.
